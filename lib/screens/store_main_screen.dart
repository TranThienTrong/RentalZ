...
import 'package:rental_apartments_finder/screens/stores/explore_screen.dart';
...
import 'package:rental_apartments_finder/screens/store_homepage_screen.dart';
...
class _StoreMainScreenState extends State<StoreMainScreen> {
  ...
  var _homepageStoreScaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    ...
    try {
      _player.setAsset('assets/sounds/alert.mp3');
    } catch (e) {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.dynamic_feed), label: 'Explore'),
          BottomNavigationBarItem(
